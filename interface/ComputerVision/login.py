...
def login_page() -> rx.Component:
    ...
    login_form = rx.form(
        ...
        rx.button("Login", type_="submit", is_loading=LoginState.is_loading, style=style.button_style),
    ...
    return rx.fragment(
        rx.cond(
            ...
            rx.vstack(
                ...
                login_form,
                rx.link("Register", href=REGISTER_ROUTE, color="#aeaeae"),
                padding_top="10vh",
...
def require_login(page: rx.app.ComponentCallable) -> rx.app.ComponentCallable:
    ...
    checkinpage.__name__ = page.__name__
    return checkinpage